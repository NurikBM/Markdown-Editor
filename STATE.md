...
- **Current Milestone:** Milestone 5.2 — Document Export Pipeline (HTML & PDF) [COMPLETED] / Git History Polish
...
2. **Milestone 5.4**: Table of Contents (ToC) generation directly from AST Heading blocks with click-to-scroll navigation.
3. **Milestone 5.5**: In-document Find & Replace across block boundaries.
