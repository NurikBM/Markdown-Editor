package com.markdown.editor.presentation.security
...
/**
 * Helper facilitating biometric and device-credential authentication for document security.
 */
    ...
    fun authenticate(
        ...
        if (!canAuthenticate(activity)) {
            onError(
                ...
                "No screen lock configured. Please set a PIN, pattern, or fingerprint in Android Settings."
            )
            return
        }
