    ...
    private fun loadDocument(documentId: String) {
        viewModelScope.launch {
            ...
            result.onSuccess { doc ->
                ...
                val isLocked = activeDoc.isLocked || (uiState.value.recentDocuments.find { it.id == documentId }?.isLocked ?: false)
                ...
                updateState {
                    copy(
                        ...
                        isUnlockedForSession = isUnlocked
                    )
                }
    ...
    private fun setDocumentLocked(isLocked: Boolean) {
        ...
        viewModelScope.launch {
            ...
            if (result.isSuccess) {
                ...
                val msg = if (isLocked) "Document protected with biometrics. Tap lock to lock now." else "Document lock removed"
